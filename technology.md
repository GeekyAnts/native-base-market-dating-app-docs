# Technologies Used
 The Backend process of React Native Dating App Backend are built using the core components of Node, Express, MongoDB, SocketIO. Dating App has also been constantly incorporating various other latest technologies.
* Node JS
* Express JS
* MongoDB
* SocketIO
