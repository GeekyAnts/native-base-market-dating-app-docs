...
var options = {
  ...
  port: 443,
  path: '/repos/GeekyAnts/native-base-market-dating-app-docs/branches',
  method: 'GET',
  headers: {
...
var populateBookJson = (branches) => {
  ...
  for(let i=0; i<branches.length; i++) {
    if(branches[i].name === 'master') {
      ...
      bookJsonContents.pluginsConfig.versions.options.push({
          value: 'http://rawgit.com/GeekyAnts/native-base-market-dating-app-docs/' + branches[i].name + '/_book/index.html',
